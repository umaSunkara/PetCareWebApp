...
<head>
    ...
    <title>Bangalore-Health Support</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
  ...
  <div class="card-body">
    <h5 class="card-title">Concure Pet Clinic</h5>
    <p class="card-text">No 220/11, Hennur Main Road, Kacharakanahalli, Bangalore - 560084</p>
  ...
  <div class="card-body">
    <h5 class="card-title">Precise Pet Clinic</h5>
    <p class="card-text">No.485 & 486, 8th Cross, Jeevan Bheema Nagar Main Road, Hal 3rd Stage, Jeevan Bima Nagar, Bangalore - 560075</p>
    <a href="#" class="btn btn-primary">Contact</a>
  </div>
</div>
            </li>
